function s = simClust_KPmin_KPmin_Impl(problem_data)
%% Simultane Clusterbildung -Spezialisierung KP_min, KP_min, SmallestIndex
%
...
%       help simultaneous_cluster
    s = lhp.algo.deterministic.simultaneous_cluster.simultaneous_cluster(...
        problem_data, ...
